...
public class Transaction implements Serializable {
	...
	public int getId() {
		log.entering(Transaction.class.getName(), "getId");
		log.exiting(Transaction.class.getName(), "getId", id);
		return id;
	}

	public void setId(int id) {
		log.entering(Transaction.class.getName(), "setId", id);
		log.exiting(Transaction.class.getName(), "setId");
		this.id = id;
	}
